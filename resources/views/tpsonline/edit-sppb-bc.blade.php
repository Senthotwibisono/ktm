...
<div class="box box-default">
    <div class="box-header with-border">
      <h3 class="box-title">Edit TPS SPPB BC23</h3>
      <div class="box-tools pull-right">
        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
      </div>
    </div>
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{ route('tps-sppbBc-update', $sppb->TPS_SPPBXML_PK) }}" method="POST">
        <div class="box-body">            
            <div class="row">
                <div class="col-md-6">
    ...
    <div class="form-horizontal">
        <div class="box-body">            
            <div class="row">
                <div class="col-md-12">
                    {{
                        GridRender::setGridId("tpstpsSppbBcContGrid")
                        ->enableFilterToolbar()
                        ->setGridOption('mtype', 'POST')
                        ->setGridOption('url', URL::to('/tpsonline/penerimaan/sppb-bc/grid-data?type=cont&sppbid='.$sppb->TPS_SPPBXML_PK.'&_token='.csrf_token()))
            ...
            <div class="row">
                <div class="col-md-12">
                    {{
                        ...
                        ->enableFilterToolbar()
                        ->setGridOption('mtype', 'POST')
                        ->setGridOption('url', URL::to('/tpsonline/penerimaan/sppb-bc/grid-data?type=kms&sppbid='.$sppb->TPS_SPPBXML_PK.'&_token='.csrf_token()))
                        ->setGridOption('rowNum', 10)
                        ->setGridOption('shrinkToFit', true)
