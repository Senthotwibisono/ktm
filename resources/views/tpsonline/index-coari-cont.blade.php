...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">TPS COARI Container</h3>
    </div>
    <div class="box-body table-responsive">
        ...
        {{
            ...
            ->addColumn(array('label'=>'Size','index'=>'UK_CONT','width'=>100))
...
<script type="text/javascript">
    ...
    $('#searchByDateBtn').on("click", function(){
        ...
        jQuery("#tpsCoariContGrid").jqGrid('setGridParam',{url:"{{URL::to('/tpsonline/pengiriman/coari-cont/grid-data')}}?startdate="+startdate+"&enddate="+enddate+"&by="+by}).trigger("reloadGrid");
        return false;
    });
</script>
