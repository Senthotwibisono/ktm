...
<div class="box">
    <div class="box-body table-responsive">
        ...
        {{
            ...
            ->setGridOption('url', URL::to('/container/grid-data-cy?report=1&date='.$date.'&gd='.$gd.'&type=in&_token='.csrf_token()))
...
//            ->setGridEvent('gridComplete', 'gridCompleteEvent')
            ...
            ->addColumn(array('label'=>'Operator OB','index'=>'NAMACONSOLIDATOR', 'width'=>200,'align'=>'center'))
...
//            ->addColumn(array('label'=>'Tgl. Dokumen','index'=>'TGL_SPPB', 'width'=>120,'align'=>'center'))
        ...
        {{
            ...
            ->setGridOption('mtype', 'POST')
            ->setGridOption('url', URL::to('/container/grid-data-cy?report=1&date='.$date.'&gd='.$gd.'&type=out&_token='.csrf_token()))
            ->setGridOption('rowNum', 50)
            ->setGridOption('shrinkToFit', true)
            ->setGridOption('sortname','TCONTAINER_PK')
            ->setGridOption('sortorder','DESC')
...
<script type="text/javascript">
    ...
    $('#btn-print-in').click(function() {
        ...
        window.open("{{ route('fcl-report-harian-cetak',array('','','')) }}/"+date+"/in/"+gd,"preview wo fiat muat","width=1200,height=600,menubar=no,status=no,scrollbars=yes");
    });
    ...
    $('#btn-print-out').click(function() {
        ...
        window.open("{{ route('fcl-report-harian-cetak',array('','','')) }}/"+date+"/out/"+gd,"preview wo fiat muat","width=1200,height=600,menubar=no,status=no,scrollbars=yes");
    });
</script>
