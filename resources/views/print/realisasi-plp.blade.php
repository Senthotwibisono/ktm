...
<div class="wrapper" style="text-align: center;">
    <h5 style="margin-bottom: 0;font-size: 13px;">LAPORAN REALISASI PELAKSANAAN PINDAH LOKASI PENIMBUNAN (PLP) DARI TPK {{$header['tpk']}}<br/>
        KE LAPANGAN TPS PT KODJA TERRAMARIN - {{$header['lokasi'] .' ('.$header['jenis'].')'}}
    </h5>
    <p style="margin-top: 5px;font-size: 11px;">PELAKSANA PEMINDAHAN: {{$header['consignee']}}<br />
        Tanggal: {{$header['tanggal']}}<br/>
        EX. KAPAL: {{$header['kapal']}}
    </p>
</div>
<div id="details" class="clearfix" style="font-weight: bold;">
    <table border="0" cellspacing="0" cellpadding="0" style="width: 100%;margin-bottom: 0;">
        <tr>
            <td style="font-size: 11px;"><b>SPK: {{$header['spk']}}</b></td>
            <td style="text-align: right;font-size: 11px;"><b>Tgl. Tiba: {{$header['eta']}}</b></td>
        </tr>
    </table>
    ...
    <table border="1" cellspacing="0" cellpadding="0" style="width: 100%;">
        ...
        <tr>
            ...
            <th style="text-align: center;" colspan="2">IZIN PLP</th>
            <th style="text-align: center;" rowspan="2">NO. CONTAINER</th>
            <th style="text-align: center;" colspan="3">JUMLAH</th>
            <th style="text-align: center;" rowspan="2">NOMOR SURAT PLP</th>
            <th style="text-align: center;" rowspan="2">NOMOR MOBIL</th>
            <th style="text-align: center;" rowspan="2">TPS ASAL</th>
            <th style="text-align: center;" rowspan="2">JAM<br />MASUK</th>
            <th style="text-align: center;" rowspan="2">TGL<br />MASUK</th>
        </tr>
        <tr>
    ...
    <table border="0" cellspacing="0" cellpadding="0" style="width: 100%;margin-bottom: 0;">
        ...
        <tr>
            ...
            <td style="text-align: right;font-size: 11px;"><b style="text-decoration: underline;">-</b><br />Pj. Ass. Man. Lapangan TPS</td>
        </tr>
    </table>
</div>
