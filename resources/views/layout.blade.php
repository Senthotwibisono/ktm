...
<html>
    <head>
        ...
        <link href="{{ asset("/bower_components/AdminLTE/dist/img/kodja.png")}}" rel="stylesheet" type="text/css" />    
        ...
        <link href="{{ asset("/bower_components/AdminLTE/dist/img/kodja.png")}}" rel="stylesheet" type="img/css" />    
        <!-- jQuery 2.2.3 -->
    ...
    <body class="sidebar-mini skin-blue" cz-shortcut-listen="true" style="height: auto; min-height: 100%;">
